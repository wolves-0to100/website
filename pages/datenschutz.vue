<template>
	<div class="container">
		<main>
			...
			<p>Wolves Software UG (haftungsbeschränkt)</p>
			...
			<p>
				...
				anonymisiert statistisch ausgewertet, um unseren
			...
			<p>
				...
				die der Bereitstellung der Website dienen, grundsätzlich der
			...
			<p>
				...
				oder auf Basis statistischer Auswertungen allgemein zu
				verbessern.
			</p>
			<p>
			...
			<p>
				Informationen hierzu entnehmen Sie bitte aus den Auflistungen
				der einzelnen Darstellungs-, Tracking-, Remarketing- und
			...
			<p>
				...
				pseudonymisierten Nutzerprofilen analysieren, entnehmen Sie
				bitte den unten aufgeführten Informationen zu den eingesetzten
